...
void GCodeViewer::SequentialView::Marker::render_position_window(const libvgcode::Viewer* viewer, int canvas_width, int canvas_height, const libvgcode::EViewType& view_type)
{
    ...
    if (viewer != nullptr) {
        ...
        ImGui::PushStyleVar(ImGuiStyleVar_WindowPadding , ImVec2(10.f * m_scale, 10.f * m_scale));
        ...
        if (ImGui::Button(into_u8(properties_shown ? ImGui::UnfoldButtonIcon : ImGui::FoldButtonIcon).c_str(), ImVec2(24.f * m_scale, 24.f * m_scale))) {
